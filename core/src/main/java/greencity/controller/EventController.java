...
public class EventController {
    ...
    /**
     * Method for creating a new {@link EventResponseDto} for the current authorized
     * user.
     *
     * @param eventCreateRequestDto {@link EventCreateRequestDto} with event data.
     * @param images                array of event images, can be null.
     * @param mainImageIndex        index of the main image in the images array, can
     *                              be null.
     * @param user                  {@link UserVO} current authorized user who
     *                              organizes the event.
    ...
    public ResponseEntity<EventResponseDto> createEvent(
        @Parameter(description = "Event data") @Valid @RequestPart EventCreateRequestDto eventCreateRequestDto,
        @Parameter(description = "Event images, max 5") @RequestPart(required = false) MultipartFile[] images,
